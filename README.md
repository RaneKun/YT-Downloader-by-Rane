...
_Easy way to do that is by installing [handbrake](https://handbrake.fr/), creating a custom preset there for your requirement, and then exporting that as a `.json` file ✅📁_
